...
| 순위 | 항목 | 이유 | 난이도 | 의존성 |
|---|---|---|---|---|
| 1 | **B. 표적 영역 국소 강조**(unsharp+CLAHE, saliency 마스크) | 가장 범용적, 즉시 체감, 저위험 | 중 | 기존 saliency 재사용 |
| 2 | **A. CFAR 검출** | 표적 마스크 품질↑ → B/C 전부 개선 | 중 | numpy만 |
| 3 | **C. 클래스별 형상+신뢰도 주석** | "무엇인지" 명시, 비행체 대응 | 중상 | rectify 확장 |
| 4 | (선택) **D. 표적 초해상** | 디테일 복원, 단 비용·허상 위험 | 상 | 별도 SR 모델 |
